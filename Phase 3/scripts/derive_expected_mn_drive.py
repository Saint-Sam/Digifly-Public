...
from expected_gait import DEFAULT_SEGMENT_OFFSETS_MS
...
def _default_out_dir(phase3_root: Path, save_tag: str, run_name: str) -> Path:
    return phase3_root / "data" / "derived" / save_tag / run_name / "expected_mn_drive"
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Back out a motor-neuron drive template that best matches the expected gait actuator controls."
    )
    ...
    report = derive_expected_mn_drive(
